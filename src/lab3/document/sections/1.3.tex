...
\begin{lstlisting}[language=Python,caption={Move the ur5 robot end-effector using a articular proportional-derivative control method, \eqref{eq:articular_PD}, and inverse kinematics, Algorithm \ref{lst:inverse_kinematics}, to compute joint referece points from Cartesian sinusoidal reference trajectory of activity \ref{subsec:generate_sinusoidal_reference}.}, label={lst:articular_PD}]
# =========================
