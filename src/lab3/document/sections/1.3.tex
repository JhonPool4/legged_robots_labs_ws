...
\begin{lstlisting}[language=Python,caption=Move the ur5 robot end-effector so that it follows the Cartesian sinusoidal reference trajectory of activity \ref{subsec:generate_sinusoidal_reference}., label={lst:joint_PD_control_critical_damping}]
# =========================
